    ...
    <div class="modal-dialog modal-lx" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <a href="{{route('report.preparations')}}" class="close"><span aria-hidden="true">&times;</span></a>
            ...
            <table class="table table-bordered table-condensed" id='table_preparacao'>
              <thead>
                ...
                <tr class="success">
                  ...
                  <td class="text-center" colspan="1"><strong><font size=2>PB</font></strong></td>
                  <td class="text-center" colspan="1"><strong><font size=2>PL</font></strong></td>
        ...
        <div class="modal-footer">
          <a class="btn btn-primary" href="{{route('report.preparation_pdf', $preparacao->id)}}" target="_blank">Gerar PDF</i></a>
          <a href="{{route('report.preparations')}}" class="btn btn-default">Fechar</a>
        </div>
      </div>
    </div>
  </div>
...
@section('scripts')
    <script src="/js/relatorios/gerar_pdf_preparacoes.min.js"></script>
    <script src="/js/relatorios/exibir_modal_preparacao.js"></script>
