  ...
  <div class="modal-dialog modal-lx" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <a href="{{route('report.menus')}}" class="close"><span aria-hidden="true">&times;</span></a>
      ...
      <div class="modal-footer">
        <a class="btn btn-primary" href="{{route('report.menu_pdf', $cardapio->id)}}" target="_blank">Gerar PDF</i></a>
        <a href="{{route('report.menus')}}" class="btn btn-default">Fechar</a>
      </div>
    </div>
  </div>
</div>
...
@section('scripts')
    <script src="/js/relatorios/gerar_pdf_cardapios.min.js"></script>
    <script src="/js/relatorios/exibir_modal_cardapio.js"></script>
