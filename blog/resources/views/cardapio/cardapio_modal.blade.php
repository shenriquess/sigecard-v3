  ...
  <div class="modal-dialog modal-lg" id="largeModal"  role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a class="btn btn-primary" href="{{route('menu.pdf', $cardapio->id)}}" target="_blank">Gerar PDF</i></a>
        <a href="{{route('menu.show')}}" class="btn btn-default">Fechar</a>
      </div>
    </div>
  </div>
</div>
...
@section('scripts')
    <script src="/js/cardapios/gerar_pdf_cardapios.min.js"></script>
    <script src="/js/cardapios/exibir_modal_cardapio.js"></script>
