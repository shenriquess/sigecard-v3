      ...
      <div class="panel-heading">
        <h4>
          <p class="text-primary">
            <i class="fa fa-align-justify"></i>&nbsp;&nbsp;<strong>Novo Cardápio</strong>
              <a class="btn btn-primary btn-spinner btn-xs pull-right m-b-0" href="{{URL::previous()}}"><i class="fas fa-arrow-left"></i></a>
          </p>
          <h4>
      </div>
           ...
           <div class="row">
             ...
             <div class="form-group col-md-4" id="div_escola">
               ...
               <select name="select_escola" id="select_escola" onchange="" class="form-control form-control">
                  ...
                  <?php
                    if($escolas && isset($escolas)){
                      foreach($escolas as $escola){
                        echo '<option value="'.$escola->id.'">'.$escola->nome.'</option>';
                      }
                    }else{

                      session()->flash('mensagem-info','<strong>Por favor, primeiro cadastre uma Escola.</strong>');
                    }
                  ?>
                  </select>
            </div>
          ...
          <!-- Custom Tabs -->
                    ...
                    <fieldset disabled id="fieldset_2" class="scheduler-border">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-3" id="div_pl2">
                          ...
                          <div class="input-group">
                            <input  disabled type="number" onfocus="this.value='';" pattern="[0-9]+([,\.][0-9]+)?" max="100000" min="0" step="any" value="0.000" class="form-control" id="p_liquido2" name="p_liquido2"  >
                    ...
                    <fieldset disabled id="fieldset_3" class="scheduler-border">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-3" id="div_pl3">
                          ...
                          <div class="input-group">
                            <input  disabled type="number" onfocus="this.value='';" pattern="[0-9]+([,\.][0-9]+)?" max="100000" min="0" step="any" value="0.000" class="form-control" id="p_liquido3" name="p_liquido3"  >
                    ...
                    <fieldset disabled id="fieldset_4" class="scheduler-border">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-3" id="div_pl4">
                          ...
                          <div class="input-group">
                            <input  disabled type="number" onfocus="this.value='';" pattern="[0-9]+([,\.][0-9]+)?" max="100000" min="0" step="any" value="0.000" class="form-control" id="p_liquido4" name="p_liquido4"  >
                    ...
                    <fieldset disabled id="fieldset_5" class="scheduler-border">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-3" id="div_pl">
                          ...
                          <div class="input-group">
                            <input  disabled type="number" onfocus="this.value='';" pattern="[0-9]+([,\.][0-9]+)?" max="100000" min="0" step="any" value="0.000" class="form-control" id="p_liquido5" name="p_liquido5"  >
                    ...
                    <fieldset disabled id="fieldset_6" class="scheduler-border">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-3" id="div_pl6">
                          ...
                          <div class="input-group">
                            <input  disabled type="number" onfocus="this.value='';" pattern="[0-9]+([,\.][0-9]+)?" max="100000" min="0" step="any" value="0.000" class="form-control" id="p_liquido6" name="p_liquido6" >
           ...
           <!--div class="row">
             ...
             <div class="form-group col-md-12">
                 ...
                 < BAR CHART >
                 <div id="div_collapsed" class="box box-primary">
                   <div class="box-header with-border">
                     <h3 class="box-title">Gráfico de Comparação de Nutrientes</h3>

                     <div class="box-tools pull-right">

                       </button></a>
                       <button type="button" data-container="body" data-toggle="popover" data-placement="right" data-content="Expandir" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i>
                       </button>
                     </div>
...
@section('scripts')
    ...
    <script src="/js/cardapios/cadastro_cardapios.js"></script>
    ...
    <script type="application/javascript">
          <?php
              ...
              if(isset($refeicoes_destino)) {
                 echo 'var refeicoes_destino = '.json_encode($refeicoes_destino).';';
              }
