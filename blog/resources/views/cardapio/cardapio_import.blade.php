...
@section('content')
                      ...
                      <fieldset disabled id="fieldset_1" class="scheduler-border">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-3" id="div_pl1">
                            ...
                            <div class="input-group">
                              <input  disabled type="number" onfocus="this.value='';" onfocus="this.value='';" pattern="[0-9]+([,\.][0-9]+)?" max="100000" min="0" step="any" value="0.000" class="form-control" id="p_liquido1" name="p_liquido1">
  ...
  <div class="modal fade" id="myModalRef" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabelref">Informações Nutricionais da Referência</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        <div class="modal-body">
          <div class="row">
  ...
  <div class="modal fade" id="myModalTable" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lx" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabelref">Informações do Cardápio</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
...
@endsection
@section('scripts')
    <script src="/js/cardapios/importar_cardapio.js"></script>
