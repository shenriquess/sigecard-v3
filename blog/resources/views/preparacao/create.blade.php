...
@section('content')
  ...
  <div class="panel panel-default">
    <div class="panel-heading"><h4><strong>Cadastrar Preparação</strong><h4></div>
      ...
      <div class="panel-body">
        <form class="" action="#"  id="id_form" method="post">
           ...
           <div class="row">
             ...
             <div class="form-group col-md-4" id="div_tipo_preparacao">
               ...
               <select name="tipo_preparacao" id="select_tipo_preparacao" onchange="" class="form-control form-control">
                 ...
                 <?php
                   if($tipo_preparacoes && isset($tipo_preparacoes)){
                       foreach($tipo_preparacoes as $tipo_preparacao){
                         echo '<option value="' . $tipo_preparacao->id . '">' . $tipo_preparacao->nome . '</option>';
                       }
                   }else{
                     session()->flash('mensagem-info','<strong>Por favor, primeiro cadastre um Tipo de preparação.</strong>');
                   }
                   ?>
                </select>
             </div>
           ...
           <fieldset class="scheduler-border">
             <legend class="scheduler-border"><h5>Adicionar Ingrediente:</h5></legend>
               <div class="row">
                 ...
                 <div class="form-group col-md-6" id="div_item">
                   ...
                   <select name="item" data-live-search="true" title="Selecione uma opção" id="select_item" onchange="" class="form-control selectpicker">
                      <option value="0" selected="selected">Selecione uma opção</option>
                    </select>
                 </div>
               </div>
           ...
           <div class="row">
             ...
             <div class="form-group col-md-3" id="div_total">
               ...
               <div class="input-group">
                 <input type="number" onfocus="this.value='';" pattern="[0-9]+([,\.][0-9]+)?" max="100000" min="0" step="any" value="0.000" class="form-control" id="r_total" name="r_total"  >
           ...
           <div class="row">
             <div class="form-group col-md-12">
                    ...
                    <textarea style="resize: none" class="form-control" rows="3" placeholder="" id="modo_preparo" name="modo_preparo"></textarea>
              </div>
            </div>
             <div class="row">
               <div class="form-group col-md-4">
                 <button type="button" class="btn btn-default btn-block" data-toggle="modal" data-target="#myModal" data-toggle="tooltip" data-placement="top" title="Informações Nutricionais da Preparação">
...
@section('scripts')
    ...
    <script src="/js/preparacoes/cadastro_preparacoes.min.js"></script>
