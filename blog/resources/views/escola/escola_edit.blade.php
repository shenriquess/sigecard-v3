...
@section('content')
  ...
  <div class="panel panel-default">
    <div class="panel-heading"><h4><strong>Editar Escola</strong><h4></div>
        ...
        <form class="" action="#" id="id_form" method="POST">
           ...
           <div class="row">
             <div class="form-group col-md-4" id="div_nome">
               ...
               <input type="text" class="form-control"  id="nome" name="nome" value="{{ $escola->nome }}" required autofocus>
             </div>
             <div class="form-group col-md-8" id="div_descricao">
               <label for="descricao">Descrição:</label>
               <input type="text" class="form-control"  id="descricao" name="descricao" value="{{ $escola->descricao }}" autofocus>
             </div>
           </div>
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <div class="text-center"><h4 class="modal-title" id="myModalLabel">Alterar Modalidade de Ensino</h4></div>
          </div>
...
@section('scripts')
    <script src="/js/escolas/editar_escolas.min.js"></script>
