...
<html>
    <head>
       ...
       <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.0-1/js/all.min.js" integrity="sha512-NBPDzmbzjlbKiCJ4gojF6V5hwwaiATqKnSRisMaVpJVECLJ10Dd88t/YV42Y8PMWBlqvIOJtXVBz79wgYlTY7w==" crossorigin="anonymous"></script>
        ...
        <link rel="stylesheet" href="http://sigecard.com.br/css/AdminLTE.min.css" >
        <!-- Date Picker -->
        ...
        <!-- Daterange picker -->
        <link rel="stylesheet" href="http://sigecard.com.br/css/daterangepicker.css">
        <link rel="stylesheet" href="http://sigecard.com.br/css/pnotify.custom.min.css">
    </head>
    <body>
        ...
        <script src="http://sigecard.com.br/js/popper.min.js"></script>
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js" integrity="sha384-aJ21OjlMXNL5UyIl/XNwTMqvzeRMZH2w8c5cRVpzpU8Y5bApTppSuUkhZXN0VxHd" crossorigin="anonymous"></script>

        <script src="http://sigecard.com.br/js/jquery.mask.min.js"></script>
        <script src="http://sigecard.com.br/js/pnotify.custom.min.js"></script>
        <script src="http://sigecard.com.br/js/jquery.inputmask.js"></script>
        <script src="http://sigecard.com.br/js/jquery.inputmask.date.extensions.js"></script>
        <!-- daterangepicker -->
        <script src="http://sigecard.com.br/js/moment.min.js"></script>
        ...
        <!-- AdminLTE App -->
        <script src="http://sigecard.com.br/js/adminlte.min.js"></script>
        <script src="http://sigecard.com.br/js/dashboard.js"></script>
        <script src="http://sigecard.com.br/js/relatorios/gerar_pdf_cardapios.min.js"></script>
